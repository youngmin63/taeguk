...
const translations = {
  en: {
    ...
    'services.flowers.desc2': 'Taeguk Wildflower offers tailored styling for homes, shops,',
    'services.flowers.desc3': 'and outdoor landscapes.',
    'services.flowers.desc4': 'With hands-on horticulture expertise,',
    'services.flowers.desc5': 'we design green spaces that last — beautiful, healthy, alive.',
    ...
    'about.team.desc': 'We grow, we build, we smile — together. Plants, people, and our pup, (bongbong?) We create green moments that last long after the work is done.',
  ...
  ko: {
    ...
    // Home
    'home.hero.title': '여러분의 즐거움을 위해 일합니다',
    ...
    'home.about.desc1': '태국. 가족과 친절함에 뿌리를 둔 이름입니다.',
    ...
    'services.flowers.desc2': '태국 야생화는 집, 카페,',
    'services.flowers.desc3': '야외 공간에 맞춘 맞춤형 식물 스타일링을 제공합니다.',
    'services.flowers.desc4': '전문 원예 지식과 건강한 식물 관리로,',
    'services.flowers.desc5': '아름답고 지속가능한 녹색 공간을 만들어드립니다.',
    ...
    'about.team.desc': '우리는 함께 자라고, 함께 만들고, 함께 웃습니다. 식물, 사람, 그리고 우리 강아지 (봉봉?) 작업이 끝난 후에도 오래 지속되는 녹색 순간들을 만들어갑니다.',
    'about.stats.grown': '우리 온실에서 직접 재배하고 관리',
